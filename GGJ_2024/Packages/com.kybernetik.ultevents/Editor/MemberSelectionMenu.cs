...
namespace UltEvents.Editor
{
    ...
    internal static class MemberSelectionMenu
    {
        ...
        private static readonly AdvancedDropdownState
            CachedDropdownState = new();
        ...
        private static GenericDropdown _Menu;
        ...
        public static void ShowMenu(Rect area)
        {
            ...
            _Menu = new(CachedDropdownState, "Pick a Field or Method");
